...
var extendStatics = function(d8, b6) {
  extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d9, b7) {
    ...
    for (var p12 in b7) if (Object.prototype.hasOwnProperty.call(b7, p12)) d9[p12] = b7[p12];
  };
...
function __read(o6, n6) {
  ...
  try {
    ...
    try {
      if (r10 && !r10.done && (m9 = i7["return"])) m9.call(i7);
    } finally {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(e11) {
      switch (e11.label) {
        ...
        case 3:
          if (f14 = e11.sent(), l14 = f14.origin, b6 = f14.subwindowCommonModule, !(y6 = rt())) throw w(f);
    ...
    return __generator(this, function(P6) {
      switch (P6.label) {
        case 0:
          ...
          }, m9 = Date.now(), null === yt && (yt = m9), v7 = m9 - yt, a10 >= 10 || v7 > 6e5) return l14(w(e2, "Failed to connect")), [2];
          P6.label = 1;
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        ...
        case 6:
          if (p12 = n6.sent(), m9 = p12.client_id, b6 = p12.expires_in, k4 = m2(e11.liffId), m9 !== k4) throw v5(), w(I, "Failed to verify access_token");
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        ...
        case 1:
          n6.sent(), n6.label = 2;
        case 2:
          if (t2.error && t2.liffOAuth2Error) throw c13 = t2.error, s12 = t2.error_description, f14 = s12.replace(/\+/g, " "), u12 = "".concat(c13, ": ").concat(f14), w(I, u12);
  ...
  return __extends(p12, c13), Object.defineProperty(p12, "CUSTOMPLACEID_INIT", { get: function() {
    ...
    return new Proxy(t2, { get: function(t3, i7) {
      ...
      return "function" == typeof r10 ? function() {
        for (var n6 = [], s12 = 0; s12 < arguments.length; s12++) n6[s12] = arguments[s12];
